...
- **Still pending:** re-paste full Claude key + bulk-enrich the catalog (most matches show material=null until enriched); tiles/paint/vinyl remain quote-only (no priced India source found).
